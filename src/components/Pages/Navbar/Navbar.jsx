      ...
      <div className="flex justify-between items-center px-4 py-2 text-white">
        ...
        <div className="hidden lg:flex items-center gap-4">
          <ul className="flex gap-4">
            <li><Button variant="link" className="text-white">Explore opportunity</Button></li>
          ...
          <Sheet>
            ...
            <SheetContent side="left" className="bg-gray-800 text-white w-64">
              <div className="flex flex-col gap-4 mt-6">
                <Button variant="link" className="text-white justify-start">Explore opportunity</Button>
